...
for pdf_file in *.pdf; do
    ...
    exiftool -Title="$title" -Author="$author" -Subject="$subject" -Keywords="$keywords" "$pdf_file"

    echo "Set title '$title' and author '$author' and keywords '$keywords' for $pdf_file\n"
